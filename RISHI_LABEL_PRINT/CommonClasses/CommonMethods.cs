...
namespace RISHI_LABEL_PRINT.CommonClasses
{
    class CommonMethods
    {
        ...
        public static void  MessageBoxShow(string Description, string ErrorType)
        {
            try
            {
                ...
                {
                    MessageBox.Show(Description, ErrorType, MessageBoxButtons.OK, MessageBoxIcon.None);
                    CommonClasses.CommonVariable.Result = "OK";
                }
                if (ErrorType == "Error")
                {
                    MessageBox.Show(Description, ErrorType, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    CommonClasses.CommonVariable.Result = "OK";
                }
                if (ErrorType == "Information")
                {
                    MessageBox.Show(Description, ErrorType, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    CommonClasses.CommonVariable.Result = "OK";
                }
                if (ErrorType == "Question")
                {
                    DialogResult DiaResult = MessageBox.Show(Description, ErrorType, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
